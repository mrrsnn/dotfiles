...
require('lazy').setup({
  ...
  { 'folke/which-key.nvim', opts = {} },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map('n', '<leader>bb', ':bprev<CR>', { desc = '[B]uffer [B]ack'})
...

  {
    ...
    name = "rose-pine",
    config = function()
      require('rose-pine').setup({ variant = "main", dark_variant = "main", styles = { italic = false } })
  ...
  },
  {
    ...
    config = function()
      ...
      -- Vue files
      vim.cmd('autocmd BufWritePre *.vue Neoformat')
...
-- vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vue', 'vimdoc', 'vim', 'bash' },
